...
w, loss = ridge_regression(y_train, x_train, best_lambda)
y_test_pred = np.where(x_test @ w >= 0, 1, -1)
print("Valeurs uniques test set: ", np.unique(y_test_pred, return_counts=True))
create_csv_submission(test_ids, y_test_pred, "ridge.csv")